...
namespace WebApi.Controllers
{
    ...
    public class MarklistsController : ControllerBase
    {
        ...
        private List<Marklist> _marklists = new List<Marklist>
        {
            ...
            // new Marklist { id=2, rollno = 2, mark1=50,mark2=50,mark3=50,totalmarks=150 },
            // new Marklist { id=3, rollno = 3, mark1=50,mark2=50,mark3=50,totalmarks=150 },
            // new Marklist { id=4, rollno = 4, mark1=50,mark2=50,mark3=50,totalmarks=150 },
            // new Marklist { id=5, rollno = 5, mark1=50,mark2=50,mark3=50,totalmarks=150 },
        ...
        public StudentCollection GetAll(int page)
        {
            ...
            //  totalpage = (int)Math.Ceiling(totalpage);
            List<StudentMarks> sresult = result.Skip(maxRows * (page - 1))
                        .Take(maxRows)
                        .ToList();
        ...
        // public List<Marklist>Search(string filter1)
        // {
        //     try
        //         {
        //             // var result = await StudentMarks.Search(firstname, lastname);
        ...
        //                 return StudentMarks;
        //             }
        //             return StudentMarks.Where(e => e.firstname.Contains(filter1) || e.lastname.Contains(filter1));
        //         }
        //         catch 
        //         {
        //            throw;
